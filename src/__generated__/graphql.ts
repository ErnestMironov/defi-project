...
export type Balance = {
  ...
  lpBalance: Scalars['String']['output'];
};
...
export type Query = {
  ...
  maatDeposited: Scalars['String']['output'];
  ...
  variablesById?: Maybe<Variables>;
  /** @deprecated Use variablesById */
  variablesByUniqueInput?: Maybe<Variables>;
  variablesConnection: VariablesConnection;
};
...
export type QueryVariablesArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<Array<VariablesOrderByInput>>;
  where?: InputMaybe<VariablesWhereInput>;
};


export type QueryVariablesByIdArgs = {
  id: Scalars['String']['input'];
};


export type QueryVariablesByUniqueInputArgs = {
  where: WhereIdInput;
};


export type QueryVariablesConnectionArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy: Array<VariablesOrderByInput>;
  where?: InputMaybe<VariablesWhereInput>;
};
...
export enum VariablesOrderByInput {
  IdAsc = 'id_ASC',
  IdAscNullsFirst = 'id_ASC_NULLS_FIRST',
  IdAscNullsLast = 'id_ASC_NULLS_LAST',
  IdDesc = 'id_DESC',
...
export type VariablesWhereInput = {
  AND?: InputMaybe<Array<VariablesWhereInput>>;
  OR?: InputMaybe<Array<VariablesWhereInput>>;
  id_contains?: InputMaybe<Scalars['String']['input']>;
  id_containsInsensitive?: InputMaybe<Scalars['String']['input']>;
  id_endsWith?: InputMaybe<Scalars['String']['input']>;
  id_eq?: InputMaybe<Scalars['String']['input']>;
...
export type MaatUserTokensQueryVariables = Exact<{
  address: Scalars['String']['input'];
}>;


export type MaatUserTokensQuery = { __typename?: 'Query', maatUserStats: { __typename?: 'UserData', balances: Array<{ __typename?: 'Balance', asset: string, balance: any, lpBalance: string }> } };
...
export type OverviewQuery = { __typename?: 'Query', maatDeposited: string, apies: Array<{ __typename?: 'APY', apy: number }>, maatTvls: Array<{ __typename?: 'MaatTVL', staked: any, token: { __typename?: 'Token', decimals: number, symbol: string } }>, strategies: Array<{ __typename?: 'Strategy', id: string }>, maatUserStats: { __typename?: 'UserData', balances: Array<{ __typename?: 'Balance', balance: any, asset: string }> } };
...
export type RebalanceQuery = { __typename?: 'Query', maatLastRebalanceTxIds: Array<{ __typename?: 'RebalanceTxId', token: string, txId: string }>, maatActions: Array<{ __typename?: 'MaatAction', type: ActionType, txhash: string, txId?: string | null, timestamp: number, data: any }>, strategyStats: Array<{ __typename?: 'StrategyStats', protocol: string, apy: number, chainName: string, strategyId: string }> };
...
export type TxHistoryDesktopQuery = { __typename?: 'Query', maatActions: Array<{ __typename?: 'MaatAction', type: ActionType, txhash: string, txId?: string | null, timestamp: number, id: string, data: any, chain: { __typename?: 'Chain', name: string, id: string }, token: { __typename?: 'Token', symbol: string } }>, maatActionsConnection: { __typename?: 'MaatActionsConnection', totalCount: number }, strategyStats: Array<{ __typename?: 'StrategyStats', apy: number, chainId: string, chainName: string, decimals: number, deposited: any, strategyId: string, protocol: string, tokenAddress: string, tokenSymbol: string }> };
