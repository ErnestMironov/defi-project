...
>(({ className, children, ...props }, reference) => (
  <SelectPrimitive.Trigger
    ref={reference}
    className={cn(
      'group flex h-10 w-fit items-center justify-between rounded-md border border-slate-200 bg-cards px-3 py-2 text-sm placeholder:text-slate-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-slate-800 dark:bg-slate-950 dark:placeholder:text-slate-400',
      className,
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="ml-2 size-4 opacity-50 transition group-data-[state='open']:rotate-180" />
