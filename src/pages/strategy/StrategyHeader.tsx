...
export const StrategyHeader = (props: StrategyHeaderProperties) => {
  ...
  const { id } = useParams()
  return (
    <div className={cn('mt-10 flex items-center gap-8', className)} {...rest}>
      <div className="flex items-center -space-x-3 *:size-16">
      ...
      <div className="justify-center space-y-3">
        <h1 className="text-[2rem]/[2.4rem]">USDC / Arbitrum / Spark</h1>
        <div className="flex items-center gap-2">
          <p className="text-lg text-gray-100">Address {shortenString(id ?? '', 7)}</p>
