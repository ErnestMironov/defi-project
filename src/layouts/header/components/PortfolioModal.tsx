    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed right-0 top-0 z-[100] mt-4 flex max-md:mr-0 max-md:mt-0 max-md:w-full max-md:bg-cards-widget max-md:p-4 md:mr-4"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          exit={{ opacity: 0, x: 50 }}
          transition={{ duration: 0.3 }}
        >
          <div className="fixed inset-0 bg-black/50 max-md:block md:hidden" />
