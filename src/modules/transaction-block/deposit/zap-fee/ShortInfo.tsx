...
const ShortInfo: React.FC<ShortInfoProperties> = ({ openHandler, ...props }) => {
  return (
    <div
      {...props}
      onClick={openHandler}
      className="flex cursor-pointer items-center justify-center gap-5 border-t border-t-stroke-100 bg-[rgba(133,_133,_169,_0.03)] px-6 py-3 max-lg:gap-3  max-lg:text-[0.8125rem]"
    >
