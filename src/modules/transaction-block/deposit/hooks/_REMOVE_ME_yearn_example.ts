...
const run = async () => {
  ...
  try {
    ...
    console.info('>> create contract calls quote request', contractCallsQuoteRequest)
    ...
    console.info('>> Execute transaction', contactCallsQuoteResponse.transactionRequest)

    const hash = await client.sendTransaction(
      transformTxRequestToSendTxParameters(
        client.account,
