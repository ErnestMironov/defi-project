...
export default function UserLevel({ className, ...props }: UserLevelProperties) {
  return (
    <div className="relative flex w-full flex-col gap-3 rounded-xl border-[1.5px] border-stroke-100 bg-cards-widget p-6 pb-3 shadow-[0px_6px_36px_0px_rgba(0,0,0,0.09),_0px_6px_9px_0px_rgba(0,0,0,0.04)] max-md:border-none">
